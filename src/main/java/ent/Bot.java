...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "@TasvirniMatngaBot";
    }

    @Override
    public String getBotToken() {
        return "5379260374:AAHbXFSRIQMDVPw60n_H9rZ8NBQe9qJHMAw";
    }
    ...
    public String downloadPhoto(GetFile getFile, String fileId) {
        String path = "downloads" + java.io.File.separator + fileId + ".png";
        try {
    ...
    public void sendDoc(SendDocument document) {
        try {
            execute(document);
        } catch (TelegramApiException e) {
            e.printStackTrace();
